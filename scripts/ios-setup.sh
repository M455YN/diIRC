...
echo "  2. Get your real Team ID (Settings → Accounts → Team → Team ID), then:"
echo "       export APPLE_DEVELOPMENT_TEAM=AB12CD34EF"
echo "     Do NOT use the placeholder XXXXXXXXXX."
echo "  3. First time: npm run ios:open → Signing & Capabilities → Personal Team"
echo "  4. Build a signed IPA:"
